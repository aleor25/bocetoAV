...
<div class="py-6 px-2 md:py-[70px] md:px-[70px] min-h-screen">
    <div class="flex flex-col lg:flex-row gap-8 w-full h-full items-stretch">
        <!-- Contenedor del visor 3D -->
        <div class="w-full h-[400px] md:h-[600px] lg:h-[80vh] lg:w-1/2 flex items-center justify-center rounded-[12px] shadow-md border-2 mb-6 lg:mb-0" style="border-color: var(--primary);">
            <div class="relative w-full h-full rounded-lg shadow-lg font-bold flex flex-col">
                ...
                <div class="absolute top-2.5 right-2.5 z-10 flex items-center justify-end">
                    <div class="relative group">
                        ...
                        <a
                            ...
                            class="bg-[var(--info)] text-[var(--primary)] text-[1.4rem] font-bold px-4 mx-2 py-2 rounded-[10px] cursor-pointer border-none inline-flex items-center justify-center">
                            <img src="{{ asset('images/SIGN.png') }}" alt="Ayuda" class="w-5 h-5 object-contain" />
                        </a>
                        <!-- Leyenda flotante -->
                        <div
                            id="floatingLegend"
                            class="absolute top-0 left-full ml-3 w-[90vw] max-w-[320px] bg-white text-[var(--primary)] border border-[var(--primary)] rounded-lg shadow-xl p-5 text-sm z-50 hidden group-hover:block">
                            <h3 class="font-bold mb-4 text-base">Instrucciones de uso</h3>
                            <ul class="space-y-3">
                                <li class="flex items-start gap-3">
                                    <i class="fas fa-expand text-[1rem] mt-1 text-[var(--primary)]"></i>
                                    <span><b>Pantalla completa:</b> Haz clic para ampliar la visualización del modelo.</span>
                                </li>
                                <li class="flex items-start gap-3">
                                    <i class="fas fa-sync-alt text-[1rem] mt-1 text-[var(--primary)]"></i>
                                    <span><b>Reiniciar vista:</b> Restaura la orientación inicial del modelo.</span>
                                </li>
                                <li class="flex items-start gap-3">
                                    <i class="fas fa-mouse-pointer text-[1rem] mt-1 text-[var(--primary)]"></i>
                                    <span><b>Ver detalles:</b> Haz clic sobre un átomo para obtener información específica.</span>
                                </li>
                                <li class="flex items-start gap-3">
                                    <i class="fas fa-cogs text-[1rem] mt-1 text-[var(--primary)]"></i>
                ...
                <!-- Controles abajo -->
                <div class="absolute left-2.5 right-2.5 bottom-2.5 z-10 flex flex-col md:flex-row justify-between items-center gap-2 min-h-[50px] px-2 md:px-4 py-2 rounded-lg">
                    <!-- Selector de vistas a la izquierda -->
                    <select id="renderMode"
                        class="w-full md:w-max h-9 px-3 py-2 border-2 border-[#00455e] text-[14px] bg-white rounded-lg font-bold focus:outline-none transition-colors duration-300 mb-2 md:mb-0">
                    ...
                    <div class="flex flex-col md:flex-row gap-2 w-full md:w-auto">
                        <button
                            class="w-full md:w-max h-9 px-3 flex items-center justify-center gap-2 bg-[var(--secondary)] text-[0.9rem] font-bold rounded-lg cursor-pointer border-2 border-[var(--primary)] transition-colors duration-300"
                            id="fullscreenButton">
                            <i class="fas fa-expand"></i> Pantalla completa
                        </button>
                        <button
                            class="w-full md:w-max h-9 px-3 flex items-center justify-center gap-2 bg-[var(--accent)] text-[0.9rem] font-bold rounded-lg cursor-pointer border-2 border-[#00455e] transition-colors duration-300"
                            id="resetViewButton">
        ...
        <div class="w-full h-[400px] md:h-[600px] lg:h-[80vh] lg:w-1/2 flex items-center justify-center rounded-[12px] shadow-md border-2" style="border-color: var(--primary);">
            <div class="p-3 md:p-5 w-full h-full flex flex-col justify-between rounded-[12px]">
                <div class="mb-4 w-full">
                    <!-- ...contenido panel de carga... -->
                    <h3 class="text-2xl md:text-3xl font-bold mb-2 text-center">Busca tu archivo PDB</h3>
                    ...
                    <table class="w-full mt-6 text-xs md:text-base">
                        <tr>
