    ...
    <div class="flex flex-col items-center py-[70px] px-[70px] text-center w-full">
        ...
        <div class="flex justify-center w-full mt-8">
            <a href="{{ route('render-online') }}"
                class="text-[1.2rem] py-3 px-6 rounded-lg cursor-pointer flex items-center justify-center gap-2 border-none transition-all duration-400 shadow-md min-w-[180px] hover:bg-[var(--secondary)] hover:-translate-y-1 hover:shadow-lg active:translate-y-0.5"
