...
<div style="background-color: var(--info);" class="w-full">
    <div class="flex flex-col items-center py-[40px] px-4 md:py-[70px] md:px-[70px] text-center w-full">
        <!-- Hero Top -->
        <div class="flex flex-col md:flex-row items-center justify-center gap-5 mb-5 flex-wrap">
            <img src="{{ asset('images/desk.png') }}" alt="Monitor" class="w-full max-w-[300px] md:max-w-[400px] animate-pulse" />
            <div class="text-center max-w-full md:max-w-[500px] flex flex-col items-center">
        ...
        <div class="flex justify-center w-full mt-2">
            <a href="{{ route('render-online') }}"
                class="text-[1rem] md:text-[1.2rem] py-3 px-6 rounded-lg cursor-pointer flex items-center justify-center gap-2 border-none transition-all duration-400 shadow-md min-w-[140px] md:min-w-[180px] hover:bg-[var(--secondary)] hover:-translate-y-1 hover:shadow-lg active:translate-y-0.5"
    ...
    <div style="background-color: #fff;" class="w-full">
        <div class="flex flex-col md:flex-row items-center justify-center px-4 md:px-[70px] py-12" style="color: var(--primary);">
            <!-- Imagen -->
            <div class="w-full md:w-1/2 flex justify-center md:justify-start order-2 md:order-1">
                <img src="{{ asset('images/tbp-icon.png') }}"
                    alt="Icono tabla periódica"
                    class="w-full max-w-[150px] md:max-w-[300px] h-auto m-2 transition-transform duration-300 hover:scale-110" />
            </div>
            <!-- Texto + Botón -->
            <div class="w-full md:w-1/2 flex flex-col items-center md:items-end text-center md:text-right order-1 md:order-2">
                <h2 class="text-2xl mb-2">Explora la tabla periódica</h2>
                <p class="mb-4 w-full max-w-[500px] text-center md:text-right">
                    Descubre todos los elementos químicos, sus propiedades y características de manera interactiva. Una herramienta esencial para estudiantes y amantes de la química.
                </p>
                <a href="{{ route('periodic-table') }}"
                    class="inline-flex items-center justify-center text-[1.2rem] py-3 px-6 rounded-lg cursor-pointer gap-2 transition-all duration-400 shadow-md hover:bg-[var(--secondary)] hover:-translate-y-1 hover:shadow-lg active:translate-y-0.5 my-4"
                    style="background-color: var(--primary); color: #fff;">
